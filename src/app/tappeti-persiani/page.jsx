    ...
    return (
        <div>
            ...
            <div className={`mainContent ${styles.textPage}`}>
                ...
                <p>L&apos;arte del tessuto sembra sia stata praticata da antichissime popolazioni indiane trasmessa poi agli assiri. Agli <Link target='_blank' href='https://it.wikipedia.org/wiki/Egitto'>egiziani</Link> si deve l&apos;invenzione e diffusione del telaio, modesta ai suoi inizi.</p>
