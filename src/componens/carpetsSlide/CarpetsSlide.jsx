...
function CarpetsSlide() {
    ...
    <div className={styles.container}>
        <div className={styles.sectionCarpets}>
            ...
            <div className={styles.img}><Image src='/tappeto-persiano.jpg' loading='lazy' width='881' height='588' layout='responsive' alt='tappeto persiano' /></div>
            <div className={styles.img}><Image src='/tappeto-caucausico.jpg' loading='lazy' width='575' height='718' layout='responsive' alt='tappeto caucausico' /></div>
