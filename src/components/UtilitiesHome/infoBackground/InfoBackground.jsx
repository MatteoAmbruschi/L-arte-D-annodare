...
function InfoBackground() {
  ...
  const textLavaggio = <><strong>Il lavaggio del tappeto</strong> è un operazione delicata che <strong>non si può improvvisare, anche perché non tutti i tappeti sono uguali,</strong> noi garantiamo <strong>il miglior lavaggio</strong> e più che le parole facciamo parlare i fatti. Offriamo inoltre gratuitamente il controllo e l&apos;eventuale intervento di piccoli restauri atti ad evitare spese gravose in futuro. Naturalmente per il ritiro e la consegna ci pensiamo noi.</>
